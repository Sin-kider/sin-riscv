...
object RV32I {
  ...
  val table = Array(
    ...
    INST.JAL  -> List(rs1.NOP, rs2.NOP, rd.EN, op1.PC, op2.IMM, alu.ADD, imm.J, branch.NOP, mem.NOP, csr.NOP),
    INST.JALR -> List(rs1.EN, rs2.NOP, rd.EN, op1.PC, op2.FORE, alu.ADD, imm.I, branch.NOP, mem.NOP, csr.NOP),
    // (Env)
